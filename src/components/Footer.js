...
const Footer = () => {
  return (
    <footer className="flex flex-col lg:flex-row justify-between gap-6 border-b border-[#171848]/10 py-4 px-10 ">
      <div className="lg:max-w-[45%]  px-[5%] space-y-[25px] border-r border-[#171848]/10 pr-4">
        ...
        <div className="bg-[#018870] rounded-full p-2 px-4 flex text-white gap-4  max-w-[30%] lg:max-w-[40%]">
